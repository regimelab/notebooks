...
Interesting papers or books about Gaussian/stochastic processes, bayesian statistics, causal inference, and ecosystem or climate modeling. The first section emphasizes models influenced by statistical physics/mechanics and thermodynamics and their relation to state transitions: ideas about hysteresis, irreversibility in the dynamics and early warning signals for critical transitions. 
